...
import { homeCategories, homeCountry, homeTheme } from '@/data/home-data/homeListData'
                    ...
                    <div className='flex flex-col py-16 space-y-20 lg:w-[1340px] w-screen px-4'>
                        ...
                        <div className='flex flex-col space-y-4'>
                            ...
                            <div className='flex flex-row w-full space-x-6 '>
                                ...
                                <Link href={"/tools-page"}>
                                    <div className='relative flex flex-col h-56 w-56 bg-red-400 rounded-xl overflow-hidden group'>
                                        <div className='absolute top-3 left-2 z-10 text-white font-bold'>Design</div>
                                        <span className='absolute top-10 left-2 z-10 text-white text-xs font-bold opacity-0 transition-opacity duration-300 ease-in-out group-hover:opacity-100'>
                                            Developing....
                                        </span>
                                        <Image
                        ...
                        <div className='flex flex-col space-y-4'>
                            <div className='space-y-2'>
                                ...
                                <p className='text-center text-lg text-neutral-600'>Check to see which product theme is right for you</p>
                            </div>
                        ...
                        <div className='flex flex-col space-y-4'>
                            <div className='flex flex-row space-x-4 items-center justify-center'>
                                <div className='flex-grow space-y-4'>
                                    <p className='font-bold text-lg text-green-500'>COLLECTIONS</p>
                                    <p className='font-bold text-5xl'>Products by country</p>
                                    <p className='text-lg text-neutral-600'>Choose products according to your favorite country</p>
                                </div>
                                <div className=''>
                                    <button className='text-gray-200 bg-neutral-950 px-4 py-2 rounded font-bold'>Explore collections</button>
                                </div>
                            </div>
                                ...
                                {listCountry.map((item: any, index) => (
                                    <Link key={index} href={"/"}>
                                        <div className='relative'>
                                            ...
                                            <p className='text-neutral-500 text-sm'>{item.count} resources</p>
                                        </div>
                                    </Link>
                                ))}
                            </div>
                        ...
                        <div className='flex flex-col space-y-14'>
                            ...
                            <div className='flex flex-row'>
                                <div className='space-y-4'>
                                    ...
                                    ></video>
                                    <h3 className='text-2xl font-bold'>Best quality or nothing</h3>
                                ...
                                <div className='space-y-4' >
                                    <video
                                        ...
                                        className="rounded _1286nb14ku _1286nb14m6 _1286nb14ni _1286nb14ou _1286nb196"
                                    ></video>
                                    <h3 className='text-2xl font-bold'>Ready-to-use everything</h3>
                                    <p>Download scroll-stopping images of the highest quality to make professional designs.</p>
                                </div>
                                <div className='space-y-4'>
                                    <video
                                        ...
                                        className="rounded _1286nb14ku _1286nb14m6 _1286nb14ni _1286nb14ou _1286nb196"
                                    ></video>
                                    <h3 className='text-2xl font-bold'>Fresh content every day</h3>
                        ...
                        <div className='flex flex-row bg-purple-600 items-center justify-center'>
                            <div className='flex flex-col space-y-4 pl-40 text-white flex-grow h-full'>
                                ...
                                <p className='font-bold text-lg'>Pick a template, customize it online, and make it yours</p>
                                <div className='space-x-4'>
                                    <button className='bg-white text-black font-bold text-xs px-4 py-2 rounded'>Start editing</button>
                                    <button className='text-white border border-white font-bold text-xs px-4 py-2 rounded'>Start editing</button>
                                </div>
                            </div>
                            <div>
                                <Image
