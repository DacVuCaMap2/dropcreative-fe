...
export default function AddProductComponent() {
  ...
  const [contentCalling, setContentCalling] = useState('<p>Initial content</p>');
  ...
  return (
    <div>
      <p>Build a landing page to display demos on search pages or sell products on the market</p>
          ...
          <div className='border px-4 py-4 text-neutral-600 space-y-4 shadow-lg'>
            ...
            <div className='space-y-2'>
              <div className="flex items-center space-x-2">
                <label className="text-sm font-bold">Content calling for purchases *</label>
