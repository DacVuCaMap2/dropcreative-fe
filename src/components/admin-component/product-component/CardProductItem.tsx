...
export function CardProductItem(props: Props) {
  ...
  return (
    <div className="shadow-lg transition-transform trasistion border border-neutral-300 text-neutral-600 rounded-3xl h-[500px] flex flex-col hover:shadow-2xl duration-300 ease-in-out overflow-hidden hover:bg-gray-100">
      <div className="h-80 overflow-hidden flex items-center justify-center mb-2">
      <div className="relative h-full w-full group">
  <Link href={"/admin/all-product/edit/" + data.id} target="_blank">
    <Image 
      width={1200} 
      height={1200} 
